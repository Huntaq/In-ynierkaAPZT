          ...
          <div className={` fixed  transition-all  ease-in-out  h-[30px] content-center  top-0 left-0 w-full bg-[#4BD0FF] z-50 ${notificationPopupVisible ? 'visible' : 'invisible'}`} ref={popupRef}>
            <div className='relative flex justify-center text-center'>
              <div className=' justify-self-center'>
                <p className='font-bold text-[16px] text-white uppercase CustomXSM:text-[12px] CustomXXSM:text-[10px]'>{notifications[currentNotificationIndex]?.header} / </p>
              </div>
              <div className=' justify-self-center'>
                <p className='text-[16px] text-white CustomXSM:text-[12px] CustomXXSM:text-[10px]'>&nbsp;{notifications[currentNotificationIndex]?.content}</p>
              </div>
